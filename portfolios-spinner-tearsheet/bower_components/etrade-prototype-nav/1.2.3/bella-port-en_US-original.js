        ...
        (function() {
            ...
            closeMegaMenu = function() {
                ...
                if ($openTab && !closing) {
                    ...
                    if ($('.megamenu .tab').filter(isDisplay).length === 0) {
            ...
            pinMegaMenu = function() {
                pinned = true;
            };

            unpinMegaMenu = function() {
                pinned = false;
            };
            ...
            $nav.bind("mousemove", function(event) {
                if (prevMouseX != event.pageX || prevMouseY != event.pageY) {
                    prevMouseX = event.pageX;
                    prevMouseY = event.pageY;
                    //This is for IE, to ignore first occurrence of mousemove.
                    if (mousemoveCount++ === 0) return;
                    mousemoved = true;
                }
            });

            hover(".menubar .menu:not(.selected)", function(event) {
                if (mousemoved) openTab($(this));
            }, $.noop);
