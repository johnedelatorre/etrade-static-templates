...
(function($, csrfToken) {
    ...
    $(function() {
        ...
        (function() {
            ...
            this["JST"]["bella-nav"] = function(data) {
                ...
                __p += '<div class="background">\n\t<div class="tray"></div>\n</div>\n\n<div class="globalnav">\n\t<span class="date"></span>' + 
                		'\n\t<a href="#">' +
                    ((__t = (data.globalNav.home.title)) == null ? '' : __t) +
                    '</a>' +
                    '\n\t<a href="#">' +
                    ((__t = (data.globalNav.threesixty.title)) == null ? '' : __t) +
                    '</a>' +
                		'\n\t<a href="#">' +
                    ((__t = (data.globalNav.completeview.title)) == null ? '' : __t) +
                    '</a>' +
        ...
        (function() {
            ...
            function setRowStatus(rowObj, oInput) {
                ...
                rowObj.mouseup(function(e) {
                    ...
                    //For Symbol search
                    if (oInput.hasClass('searchsymbol')) {
        ...
        (function() {
            ...
            $nav.delegate(".megamenu", "mouseleave", closeMegaMenu);

            $nav.delegate(".menubar .menu:not(.selected)", "click", function(event) {
                openTab($(this));
            });

            $nav.delegate(".menus h3", "mouseenter", function(event) {
