            ...
            this["JST"]["bella-nav"] = function(data) {
                ...
                $.each(data.tray.indices.symbols, function(i, symbol) {;
                    __p += '\n\t\t\t\t<a\n\t\t\t\t\thref="' +
                        ...
                        '"\t\t\t\t>' +
                        '<span class="index-symbol">' + ((__t = (symbol.title)) == null ? '' : __t) + '</span><span class="percent-change">&mdash;</span>' +
                        '<br><span class="change">&mdash;</span><span class="last">&mdash;</span></a>\n\t\t\t';
                });
...
#bella-nav .megamenu .tray > span a:hover span.change, #bella-nav .megamenu .tray > span a:hover span.percent-change {\
  display: inline-block;\
  text-align: right;\
}\
#bella-nav .megamenu .tray > span a.gain .last, #bella-nav .megamenu .tray > span a.gain .change {\
  background: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAICAYAAADN5B7xAAAAcElEQVQYV2P4//8/Azo2XmvcC8LY5DAE9FfqOwHxfyh2wqtBc7EmPxA/BOL/UAxi8+PUoDhHcT4Q/0fD87FqkJoiFQLE/3HgEBQNQj1CEkD8Foj/48AgOQm4Bq5Wri1A/J8A3gLWwFLPkgbE/4nEaQBpZcut5/ffxAAAAABJRU5ErkJggg==') left center no-repeat;\
  padding-right: 2px;\
}\
#bella-nav .megamenu .tray > span a.loss .last, #bella-nav .megamenu .tray > span a.loss .change {\
  background: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAICAYAAADN5B7xAAAAgElEQVQYV2N4EO1pBsR/gPg/AQxSY8bw//9/hjvhro1A/J8AbgSpBWu4GmjPDMQngfg/DgySY4ZrAOFznhbqQPwNiP+jYZCYOkwdXAMIH3MyyAfi/2g4H1kNigYQ3melsQuI/0PxLnR5DA3bjRSlgfgtFEsT1ADCG3Wko0AYmxwA7A7u6YNhykoAAAAASUVORK5CYII=') left center no-repeat;\
  padding-right: 2px;\
}\
...
#bella-nav div.etsearch div.text-go-btn {\
  float: left;\
  background: -webkit-linear-gradient(top, #19191b, #36363c);\
  background: linear-gradient(to top, #19191b, #36363c);\
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#19191b, endColorstr=#36363c, GradientType=0);\
  position: relative;\
...
var current = (targetpage) ? parse(targetpage) : parse(testurl1);  */
        ...
        (function() {
            ...
            updateIndex = function(index) {
                ...
                $index.children("span.percent-change").text(percentChange+'%');
            };
