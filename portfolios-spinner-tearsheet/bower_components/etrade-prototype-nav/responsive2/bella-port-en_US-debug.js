...
(function($, csrfToken) {
    ...
    $(function() {
                ...
                "menus": [{
                    ...
                    "columns": [
                        ...
                        [{
                            ...
                            "links": [{
                                "title": "Stocks",
                                "url": "https://sit.etrade.com/ctnt/investor-education-center/educational-resources#cb9c7b50"
                            }, {
                                "title": "Options",
                                "url": "https://sit.etrade.com/ctnt/investor-education-center/educational-resources#07b56ef1"
                            }, {
                                "title": "Trading",
                                "url": "https://sit.etrade.com/ctnt/investor-education-center/educational-resources#3a65a351"
                            }, {
                                "title": "Investing",
                                "url": "https://sit.etrade.com/ctnt/investor-education-center/educational-resources#1f1aa522"
                            }, {
                                "title": "Retirement",
                                "url": "https://sit.etrade.com/ctnt/investor-education-center/educational-resources#486af855"
                            }]
                        }]
                    ]
                }, {
        ...
        var html = '<div class="hamburglar-options"><div class="contact"><span class="call">Call E*TRADE 1-800-387-2331</span></div><div class="log-out-wrapper"><a class="log-out" href="#">Log Out</a></div><ul class="mobile-nav">';
        $.each(model.megamenu, function(index, data) {
            html += '<li class="section"><span class="sect-header">' + data.title + '</span><ul class="subsections">';

            if (data.menus) {
                $.each(data.menus, function(i, d) {
                    if (d.columns) {
                        html += '<li class="subsection-item"><span class="sect-title">'+d.title+'</span><span class="et-icon-chevron-right"></span><ul class="sect-pages" style="display: none;">';
        ...
        $(document).ready(function() {
            $('#bella-nav').before(html);
            $('.subsection-item').on("click", function(){
                if($(this).find(".sect-pages:visible").length){
                    $(this).removeClass("expanded");
                    $('.sect-pages').slideUp(250);
                    return;
                }
                $('.sect-pages').slideUp(250);
                $('.subsection-item').removeClass("expanded");
                $(this).addClass("expanded").find(".sect-pages").slideDown(250);
            });
            $(".hamburglar, .close-menu" ).on("click", function() {
              $(this).toggleClass("active");
              $('body').toggleClass("responsive-slide");
            });
            $("#bella-nav .search-trigger").on("click", function(){
        ...
        (function() {
            ...
            this["JST"]["bella-nav"] = function(data) {
                ...
                __p += '<div class="background">\n\t<div class="tray"></div>\n</div>\n\n<div class="globalnav">\n\t<span class="date"></span>\n\t<a class="suggestions" href="#">' +
                    ...
                    '</a>\n</div>\n\n<div class="menubar"><div class="search-trigger"></div>\n\t<span href="javascript:;" class="hamburglar"></span><a class="logo">E*TRADE FINANCIAL</a>\n\t';
...
text-align: center;\
background-color: #fff;\
background-image: url('data:image/png;base64,');\
